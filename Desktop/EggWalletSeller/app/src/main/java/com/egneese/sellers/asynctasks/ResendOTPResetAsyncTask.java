 ...
 */
public class ResendOTPResetAsyncTask extends AsyncTask<Void, Void, Void> implements NetworkConstants {
    ...
    public ResendOTPResetAsyncTask(Context context , RequiredDTO requiredDTO) {
